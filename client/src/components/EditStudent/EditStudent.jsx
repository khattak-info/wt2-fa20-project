      ...
      <div className="Edit-Student-Wrapper">
        ...
        <form onSubmit={this.updateStudentHandler}>
          ...
          <input
            ...
            id="name"
          />
          <label htmlFor="name1"> Group Name:</label>
          <input
            type="text"
            placeholder="Enter the name of the group here"
            name="name1"
            onChange={this.onChangeHandler}
            ref="name1"
            ...
            id="name1"
          />
          <label htmlFor="email">Github link: <b>(must be a valid link)</b></label>
          <input
            type="text"
            ...
            id="email"
          />
          <label htmlFor="enrollnumber">CMS ID: </label>
          <input
            type="number"
